...
class ProofRequestAdmin extends BaseAdmin
{
    ...
    public function preValidate($object): void
    {
        ...
        if ($player) {
            if (
                ...
                $this->getRequestStack()->getSession()->getFlashBag()->add(
                    'error',
    ...
    private function getPlayer(): Player
    {
        ...
        return $em->getRepository('App\BoundedContext\VideoGamesRecords\Core\Domain\Entity\Player')->getPlayerFromUser($user);
    }
}
