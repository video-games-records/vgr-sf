...
namespace App\BoundedContext\VideoGamesRecords\Shared\Domain\Tools;
...
class RankingTools
{
     ...
     * @param array<string, int> $columns array of 'column' => SORT_*
     * @return array<mixed>
     */
     ...
     */
    public static function chartPointProvider(int $iNbPartcipant): array
    {
        $liste = [];
     ...
     * @return array<int, int>
     */
    public static function platformPointProvider(int $iNbPartcipant): array
    {
        return self::chartPointProvider($iNbPartcipant);
    }

    /**
     * @param array<mixed>  $aArray
     * @param array<string>  $aBaseCol
