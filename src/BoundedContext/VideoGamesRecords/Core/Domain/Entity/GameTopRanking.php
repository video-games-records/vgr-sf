...
#[ORM\Table(name:'vgr_game_top_ranking')]
#[ORM\Index(name: "idx_game_period", columns: ["game_id", "period_type", "period_value"])]
#[ORM\Index(name: "idx_game_top_ranking_period_rank", columns: ["period_type", "period_value", "rank"])]
#[ORM\Entity(repositoryClass: GameTopRankingRepository::class)]
class GameTopRanking
{
