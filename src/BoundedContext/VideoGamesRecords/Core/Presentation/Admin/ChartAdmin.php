        ...
        if (($this->hasRequest()) && ($this->isCurrentRoute('create'))) {
            ...
            if ($this->getRequest()->getSession()->has('vgrcorebundle_admin_chart.idGroup')) {
                ...
                $entityManager = $this->getModelManager()
                    ->getEntityManager('App\BoundedContext\VideoGamesRecords\Core\Domain\Entity\Group');
                $group = $entityManager->getReference('App\BoundedContext\VideoGamesRecords\Core\Domain\Entity\Group', $idGroup);
