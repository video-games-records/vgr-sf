...
namespace App\BoundedContext\VideoGamesRecords\Core\Presentation\Block\Service;
    ...
    public function execute(
        ...
        foreach ($statusOrder as $status) {
            $query = $this->em->createQueryBuilder()
                ->from(\App\BoundedContext\VideoGamesRecords\Core\Domain\Entity\Game::class, 'game')
                ->select('game')
